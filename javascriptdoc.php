...
<html>
	...
	<div class = "nav" id ="navbar">
		...
		<div id="sidebar1" class="vert">
			...
			<tr><td><a href ="#" class="tablinks"  onclick="opendetails(event,'objects')">Objects</a></tr></td>
			<tr><td><a href ="#" class="tablinks" onclick="opendetails(event,'funct')">Functions</a></tr></td>
			<tr><td><a href ="#" class="tablinks" onclick="opendetails(event,'dom')">HTML DOM</a></tr></td>
			<tr><td><a href ="#" class="tablinks" onclick="opendetails(event,'bom')">Browser BOM</a></tr></td>
			<tr><td><a href ="#" class="tablinks"  onclick="opendetails(event,'examples')">Examples</a></tr></td>
			</table>
		</div>
		<div id ="sidebar2">
...
<?php	 } else { 
				echo "Please login to access Javascript lessions!!";
				include "login.php";
			} 
			?>